...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header id="home" class="header">
        ...
        <div class="header-content container">
            <h1 class="header-title">
                ...
                <span class="down">I am Firdavs Isroilov</span>
            </h1>
        ...
        <div class="container text-center">
            ...
            <div class="about">
                <div class="about-img-holder">
                    <img src="assets/imgs/Isroilov firdavs.jpg" class="about-img" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                </div>
        ...
        <div class="container text-center text-sm-left">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm offset-sm-2 offset-md-3">
                    <a href="tel:998936544847" class="btn btn-lg my-font btn-light rounded">Hire Me</a>
                </div>
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <div class="container">
        <footer class="footer">       
            <p class="mb-0">Copyright <script>document.write(new Date().getFullYear())</script> &copy; <a>IsroilovDev</a></p>
            <div class="social-links text-right m-auto ml-sm-auto">
                <a href="https://www.facebook.com/profile.php?id=100053310756427" target="_blank" class="link"><i class="ti-facebook"></i></a>
                <a href="https://twitter.com/isroilovdev" target="_blank" class="link"><i class="ti-twitter-alt"></i></a>
                <a href="javascript:void(0)" target="_blank" class="link"><i class="ti-linkedin"></i></a>
                <a href="https://www.instagram.com/firdavsdev/" target="_blank" class="link"><i class="ti-instagram"></i></a>
            </div>
        </footer>
